                ...
                while (true)
                {
                    ...
                    if (request.RawUrl.Contains("Json"))
                    {
                        ...
                        List<Person> people = JsonConvert.DeserializeObject<List<Person>>(json);
                         //List<Person> people = System.Text.Json.JsonSerializer.Deserialize<List<Person>>(json);
                        ...
                        {
                            stringBuilder.Append($"<li>{item.Id}) {item.Name} {item.Surname} {item.Gender} {item.Ip}</li>");
                        }
                        stringBuilder.Append("</ul>");
